    ...
    public static boolean isInComment(PsiFile psiFile, int offset) {
        ...
        try {
            ...
            if (document != null) {
                ...
                if (commentPos != -1 && isValidCommentPosition(lineText, commentPos)) {
                    return relativeOffset > commentPos;
                }
            ...
            Logger.getInstance(CommentDetector.class).warn("Error detecting comment", e);
        }
        return false;
    }
